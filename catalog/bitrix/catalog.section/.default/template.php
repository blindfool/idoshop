...
?>
<div class="catalog_items" data-count="<?=$counter?>"><div class="catalog_list">
...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	<div class="mask">
		...
		<div class="brand"><?=$arItem["DISPLAY_PROPERTIES"]["brand"]["DISPLAY_VALUE"];?></div>
		<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="btn white"><?=GetMessage('CT_BCS_TPL_MESS_BTN_DETAIL');?></a>	
	</div>
...
?>
<a href="#" class="btn" id="show-more" style="margin: 2% auto; width: 17%;"><?=GetMessage('AJAX_LOAD');?></a>
<script type="text/javascript">
$(document).ready(function(){
    //путь к файлу с компонентом. Указываем параметр
    var path = "/include/php/catalog_list.php?ajax=Y";
    //счетчик страниц
    var currentPage = 1;

 var count = $(".catalog_items").data("count");
    $("#show-more").click(function(e){
	var wait = BX.showWait('show-more');
...
<div class="section_description"><?echo $arResult["DESCRIPTION"];?></div>